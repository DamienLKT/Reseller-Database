...
CREATE TABLE `order` (
  ...
  KEY `Bill_Number_idx` (`Bill_Number`),
  KEY `Customer_ID_idx` (`Customer_ID`),
  CONSTRAINT `Bill_Number` FOREIGN KEY (`Bill_Number`) REFERENCES `payment` (`Bill_Number`),
...
CREATE TABLE `product` (
  ...
  `Product_Price` float(10,1) DEFAULT NULL,
...
-- Dump completed on 2022-02-11 19:11:10
